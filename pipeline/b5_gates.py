...
def _verified_report(root: Path) -> dict[str, Any]:
    ...
    for alias in sorted(flattened):
        ...
        if alias in group_sets["deferred"]:
            ...
            gates.append(_gate(
                ...
                "Language is deferred by the owner-approved B4 scope decision; the reason and decision remain attached.",
    ...
    return {
        ...
        "overall": overall,
        "overall_reason": (
            "The artifact violates the inherited absolute WER maximum and also "
            "lacks other required promotion evidence. Relative gain cannot "
            "override an absolute quality failure."),
        "languages": languages,
