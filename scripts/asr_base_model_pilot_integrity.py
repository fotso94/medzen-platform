...
LOCAL_RESOURCE_GATED_EXECUTOR_MODULE_PATHS = (
    *RECORDED_AWS_REHEARSAL_EXECUTOR_MODULE_PATHS,
    "scripts/asr_base_model_local_resources.py",
)
...
ATTEMPT_17_EXECUTOR_MODULE_PATHS = (
    *PROVEN_COMMAND_GATED_EXECUTOR_MODULE_PATHS,
    "scripts/asr_base_model_node_staging.py",
    "scripts/asr_base_model_pilot_workload.py",
    "scripts/qualify_asr_base_model_node_staging.py",
)
...
ATTEMPT_25_EXECUTOR_MODULE_PATHS = ATTEMPT_24_EXECUTOR_MODULE_PATHS
ATTEMPT_26_EXECUTOR_MODULE_PATHS = ATTEMPT_25_EXECUTOR_MODULE_PATHS
...
def validate_executor_module_bindings(
    ...
    if isinstance(bindings, dict):
        for candidate in (
            ...
            ATTEMPT_26_EXECUTOR_MODULE_PATHS,
        ):
