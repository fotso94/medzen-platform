#!/usr/bin/env bash
# Canonical persistent-secret cleanup for prospective packet 2026-032.
set -euo pipefail
...
cleanup_plan="/private/tmp/b6-032-cleanup-$PPID.tfplan"
targets=(
...
for observation in 1 2 3; do
  verify_plan="/private/tmp/b6-032-cleanup-stable-$PPID-$observation.tfplan"
