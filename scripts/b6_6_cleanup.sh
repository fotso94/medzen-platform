#!/usr/bin/env bash
# Independently invocable cleanup for B6-AWS-CHANGE-PACKET-2026-008.
set -euo pipefail
...
cleanup_plan="/private/tmp/b6-008-cleanup-$PPID.tfplan"
targets=(
