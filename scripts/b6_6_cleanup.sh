#!/usr/bin/env bash
# Canonical persistent-secret cleanup for prospective packet 2026-030A.
set -euo pipefail
...
cleanup_plan="/private/tmp/b6-030a-cleanup-$PPID.tfplan"
targets=(
...
for observation in 1 2 3; do
  verify_plan="/private/tmp/b6-030a-cleanup-stable-$PPID-$observation.tfplan"
