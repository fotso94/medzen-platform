...
def test_cli_exit_codes(tmp_path):
    ...
    # Round 8 (Codex): a partial invocation refuses BEFORE any semantic
    # check — the gate is complete or it is nothing
    assert b"promotion gate is COMPLETE" in ok.stdout
