...
def test_attempt_40_refuses_in_render():
    with pytest.raises(ValueError, match="attempt must be 1 through 39"):
        render(_render_bindings(), ["10.0.1.7", "10.0.2.8"], ["52.219.0.0/16"], 40)
